...
authors=['John','Michael','Luke','Sally','Joe','Liz','Lisbon','Jane']
...
class Command(BaseCommand):
    def add_arguments(self, parser):
        parser.add_argument('file_name',type=str,help="The text file that contains the journal titles")
    
    def handle(self, *args, **kwargs):
        file_name = kwargs['file_name']
        with open(f'{file_name}.txt') as files:
            for row in files:
                title = row
